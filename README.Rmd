...
(from the 2021 season). Right to use these images **only** for non-commercial purposes is kindly provided by Chris Creamer of [sportslogos.net](https://www.sportslogos.net).
...
The PNG images do not have a transparent background, so appear best in graphs with
a white background.
